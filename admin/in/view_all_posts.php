   ...
   $bulk_options = $_POST['bulk_options']; 
      ...
      switch($bulk_options){
         ...
         $query= " update posts set post_status = '{$bulk_options}' where post_id = {$postid} ";
              ...
              check_query($update_publish);
              break; 
              
        case 'draft' :
         $query= " update posts set post_status = '{$bulk_options}' where post_id = {$postid} ";
              $update_draft = mysqli_query($connection, $query);
              check_query($update_draft);
              break; 
              
        case 'delete':
         $query=" delete  posts  where post_id = '{$checkBoxArray}' ";
              $update_delete = mysqli_query($connection, $query);
              check_query($update_delete);
              break; 
...
?>
 ...
 <form action="" method="post">
  <table class="table table-bordered table-hover">
         ...
         <div id="bulkOptionsConatiner" class="col-xs-4">
...
<div class="col-xs-4">
    <input type="submit" name="submit" class="btn btn-success" value="Apply"> <a class="btn btn-primary"
 href="./posts.php?source=add_post">Add New</a>
                         </div>               
...
//         echo "<td><a  rel='$post_id' href='javascript:void(0)' class='delete_link'>Delete</a></td>";
                                ...
                                echo"<td><a name= 'reset' href='posts.php?reset={$post_id}'>reset</a></td>";
...
$reset_post_view_count = mysqli_query($connection, $query);
